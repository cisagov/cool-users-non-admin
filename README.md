...
```hcl
module "example" {
  source = "github.com/cisagov/cool-users-non-admin"
...
* [Deploying into the default VPC](https://github.com/cisagov/cool-users-non-admin/tree/develop/examples/default_vpc)
